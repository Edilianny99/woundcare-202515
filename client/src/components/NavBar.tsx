          ...
          <Box h="auto">
            ...
            <DrawerBody style={{ marginTop: "20px" }}>
              ...
              <Link href={routes.patientEducation} onClick={onClose}>
                <Flex direction="row" align="center" mb="10px">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path fill="#ffffff" fill-rule="evenodd" d="M4 8a4.5 4.5 0 0 1 4.5-4.5h10A1.5 1.5 0 0 1 20 5v15a1 1 0 0 1-1 1H7.5a3.5 3.5 0 0 1-3.465-3H4zm14.5 7.5h-11a2 2 0 1 0 0 4h11zM8.25 8A.75.75 0 0 1 9 7.25h7a.75.75 0 0 1 0 1.5H9A.75.75 0 0 1 8.25 8M9 10.25a.75.75 0 0 0 0 1.5h5a.75.75 0 0 0 0-1.5z" clip-rule="evenodd"/></svg>
                  <Heading
                    as="h3"
                    fontWeight="bold"
                    color="white"
