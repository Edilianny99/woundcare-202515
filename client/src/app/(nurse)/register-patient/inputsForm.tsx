...
export const TextFieldComponent2: React.FC<TextFieldComponentProps2> = ({
	label,
	placeholder,
	value,
	onChange,
...
export const AllergiesInputComponent: React.FC<
	AllergiesInputComponentProps
> = ({
	inputValue,
	setInputValue,
	allergies,
		...
		<>
			...
			<HStack spacing={4}>
				<Input
					...
					placeholder="Alergia"
				/>
				<Button bg="#033e5c" color="white" onClick={handleAddClick}>
					+
				</Button>
			</HStack>
			<HStack spacing={4} align="start" marginTop="20px" wrap="wrap">
				{allergies.map((value: any, index: any) => (
					<Tag backgroundColor="#419ebd" key={index}>
						{value}
...
export const DiseasesInputComponent: React.FC<DiseaseInputComponentProps> = ({
	inputDisease,
	setInputDisease,
	medicalRecord,
	handleAddClickDisease,
	handleDeleteClickDisease,
}) => {
	return (
		<>
			<Text
			...
			<HStack spacing={4}>
				...
				/>
				<Button bg="#033e5c" color="white" onClick={handleAddClickDisease}>
					+
				</Button>
			</HStack>
			<HStack spacing={4} align="start" marginTop="20px" wrap="wrap">
				{medicalRecord.map((value: any, index: any) => (
					<Tag backgroundColor="#419ebd" key={index}>
						{value}
						<TagCloseButton onClick={() => handleDeleteClickDisease(index)} />
					</Tag>
				))}
			</HStack>
		</>
...
export const SubmitButtonComponent: React.FC<SubmitButtonComponentProps> = ({
	isFormValid,
	handleSubmit,
	isLoading,
}) => (
