...
import { TheMedicalFile, ThePatientInfo } from '@/interfaces/doctor/doctor.interface'
import { getPatientInfo, getPatientMedicalFile } from '@/services/doctor/doctor.service'
