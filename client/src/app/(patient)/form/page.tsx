      ...
      <Box position="relative" key={index} marginRight={2}>
        ...
        />
            ...
            <RadioGroup onChange={setSwelling} mt={3}>
                <Radio value="Si" size="lg" colorScheme="purple" marginRight={3} >Sí</Radio>
                <Radio value="No" size="lg" colorScheme="purple">No</Radio>
            </RadioGroup>
        ...
        <Flex direction="column" align="center" p={4}>
                ...
                <Modal isOpen={isOpen} onClose={onClose} isCentered>
                    ...
                    <ModalBody>
                        <Flex direction="row" justify="space-around" wrap="wrap" gap={4}>
                        {/* Opción: Seroso */}
                        <Box
                            textAlign="center"
                            cursor="pointer"
                        ...
                        <Box
                            textAlign="center"
                            cursor="pointer"
                            onClick={() => handleSecretionTypeSelect("Serosanguinolento")}
                        >
                            <Image
