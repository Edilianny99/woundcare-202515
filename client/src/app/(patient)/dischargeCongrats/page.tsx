...
function dischargeCongrats() {
	return (
		<Box style={{ padding: "20px", display: "flex", flexDirection: "column" }}>
			<Image
				src="/dischargeCongrats/heart.png"
				alt="heart"
				width={90}
				height={90}
			/>
			<Flex direction="row" justify="flex-end" mt="-30px">
				<Image
					src="/dischargeCongrats/cross.png"
					alt="heart"
					width={110}
					height={110}
				/>
			...
			<Text
				...
				textAlign="center"
			>
				¡Felicidades por completar su tratamiento exitosamente!
			</Text>
			...
			<Text
				...
				textAlign="center"
			>
				De parte de todo el equipo de salud, esperamos que tu recuperación haya
				sido completa y exitosa
			</Text>
		</Box>
	);
}
